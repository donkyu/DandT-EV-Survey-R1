...
\item [R2: ] 
%\textbf{\textit{\textcolor{red}{This question will be answered by Al Faruque.}}}
...
As a power model fidelity significantly impacts on the power estimation and management performance [20], misprediction of any EV state will cause the power optimization algorithm to make wrong decisions and thereby resulting in overall worse EV driving range and battery lifetime.
